...
class Welch(Dataset):
    ...
    def preprocess_file(self, audio_file: Path, *, last_file_behavior: Literal["pad","truncate","discard"] = "pad", merge_files: bool = True, write_file: bool = False) -> Tuple[np.ndarray, str]:
